...
Page(A.assignPage({
  ...
  getInfo: function (goods_id) {
    ...
    return new Promise((resolve, reject) => {
      A.updata.getActDetail(goods_id, 4).then(res => {
        wx.hideLoading();
  ...
  // 复制添加
  copyAdd: function (e) {
    A.G('/pages/myshop/home/marketingPromotion/publishAct/publishAct?editType=1&actType=4&id=' + this.data.model_id + '&tag=' + this.data.tagId)
  },
  // 个人中心
