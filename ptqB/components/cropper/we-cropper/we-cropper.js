...
function prepare(_that) {
  ...
  self.createCtx = function () {
    var id = self.id;
    if (id) {
      self.ctx = wx.createCanvasContext(id, _that);
    } else {
...
function cut () {
  ...
  self.setBoundStyle = function (ref) {
    ...
    var boundOption = [
      {
        start: { x: x - lineWidth, y: y + 30 - lineWidth },
        step1: { x: x - lineWidth, y: y - lineWidth },
        step2: { x: x + 30 - lineWidth, y: y - lineWidth }
      },
      {
        start: { x: x - lineWidth, y: y + height - 30 + lineWidth },
        step1: { x: x - lineWidth, y: y + height + lineWidth },
        step2: { x: x + 30 - lineWidth, y: y + height + lineWidth }
      },
      {
        start: { x: x + width - 30 + lineWidth, y: y - lineWidth },
        step1: { x: x + width + lineWidth, y: y - lineWidth },
        step2: { x: x + width + lineWidth, y: y + 30 - lineWidth }
      },
      {
        start: { x: x + width + lineWidth, y: y + height - 30 + lineWidth },
        step1: { x: x + width + lineWidth, y: y + height + lineWidth },
        step2: { x: x + width - 30 + lineWidth, y: y + height + lineWidth }
      }
    ];
...
var WeCropper = function WeCropper (params, _that) {
  var self = this;
  var _default = {};
